...
/*   Updated: 2022/04/09 23:34:44 by hugogoorick      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	mlx_hook(all_datas.win_ptr, 4, 0, ft_mouse_click, &all_datas);
	mlx_hook(all_datas.win_ptr, 6, 0, ft_mouse_move, &all_datas);
